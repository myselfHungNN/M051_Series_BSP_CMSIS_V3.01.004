	...
	while (TRUE){
		...
		if (BoardID == 50){		
		 ...
		 HoldingRegs[Opto_HoldingRegs_50_2] = ~KB;		
			//HoldingRegs[Opto_HoldingRegs_50_1] = ~(0x0F0F);
			//HoldingRegs[Opto_HoldingRegs_50_2] = (0x0F0F);
		}
		else if (BoardID == 51){
			HoldingRegs[Opto_HoldingRegs_51_1] = ~KA;
			HoldingRegs[Opto_HoldingRegs_51_2] = ~KB;
			//HoldingRegs[Opto_HoldingRegs_51_1] = ~(0x0101);
			//HoldingRegs[Opto_HoldingRegs_51_2] = (0x0101);
		}		
		#endif
