...
#define DIR485 P32 
	...
	#define opto24  KB11
	#define opto30  KB13
	#define reserved2 KB15
	#define reserved3 KA1
	#define opto50  KA3
	#define opto56  KA5
	#define opto35  KA7
	#define opto41  KA9
	...
	#define opto54 KB14
	#define opto60 KB16
	#define KA_L ((opto24<<7)|(opto23<<6)|(opto18<<5)|(opto17<<4)|(opto12<<3)|(opto11<<2)|(opto6<<1)|(opto5<<0))
	#define KA_H ((opto48<<7)|(opto47<<6)|(opto42<<5)|(opto41<<4)|(opto36<<3)|(opto35<<2)|(opto30<<1)|(opto29<<0))
	#define KB_L ((opto56<<7)|(opto55<<6)|(opto54<<5)|(opto53<<4)|(opto52<<3)|(opto51<<2)|(opto50<<1)|(opto49<<0))
	#define KB_H ((reserved4<<7)|(reserved3<<6)|(reserved2<<5)|(reserved1<<4)|(opto60<<3)|(opto59<<2)|(opto58<<1)|(opto57<<0))	
#endif
